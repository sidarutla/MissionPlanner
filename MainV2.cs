...
namespace MissionPlanner
{
    public partial class MainV2 : Form
    {
        ...
        public MainV2()
        {
            ...
            MenuArduPilot.Image = new Bitmap(Properties.Resources._thanos_logo,
                (int) (170), 31);
        ...
        private void MenuArduPilot_Click(object sender, EventArgs e)
        {
            try
            {
                System.Diagnostics.Process.Start("https://thanos.in/");
            }
            catch
            {
                CustomMessageBox.Show("Failed to open url https://thanos.in/");
            }
        }
